...
public class LineSegment implements CurrentSegment {
  ...
  LineSegment(PVector translateVector, PVector startPosition, PVector endPosition, float current, ConfigAdjuster configAdjuster) {
...
public class ArcSegment implements CurrentSegment {
  ArrayList<CurrentElement> currentElements;
  PVector center;
  float radius;
  float degrees;
  ...
  ArcSegment(PVector translateVector, PVector center, float radius, float degrees, float current, float shift, ConfigAdjuster configAdjuster) {
    if (current >=0) {
