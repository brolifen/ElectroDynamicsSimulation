...
public class RectangularMagnet implements Magnet {
  ...
  void createCurrentSegments(PVector position) {
    ...
    CurrentSegment currentSegment1 = new LineSegment(position, new PVector(-circuitWidth/2, circuitHeight/2, 0), new PVector(circuitWidth/2, circuitHeight/2, 0), this.current, configAdjuster);
    CurrentSegment currentSegment2 = new LineSegment(position, new PVector(circuitWidth/2, circuitHeight/2, 0), new PVector(circuitWidth/2, -circuitHeight/2, 0), this.current, configAdjuster);
    CurrentSegment currentSegment3 = new LineSegment(position, new PVector(circuitWidth/2, -circuitHeight/2, 0), new PVector(-circuitWidth/2, -circuitHeight/2, 0), this.current, configAdjuster);
    CurrentSegment currentSegment4 = new LineSegment(position, new PVector(-circuitWidth/2, -circuitHeight/2, 0), new PVector(-circuitWidth/2, circuitHeight/2, 0), this.current, configAdjuster);
...
public class SplitCircularMagnet implements Magnet {
  ...
  void createCurrentSegments(PVector translationVector) {
    ...
    CurrentSegment magnetSegmennt1 = new ArcSegment(translationVector, new PVector(0, 0, 0), this.radius, 180, current, 0,configAdjuster);
    CurrentSegment magnetSegmennt2 = new ArcSegment(translationVector, new PVector(0, 0, 0), this.radius, -180, -current, 0,configAdjuster);
    CurrentSegment magnetSegmennt3 = new LineSegment(translationVector, new PVector(0, -magnetradius, 0), new PVector(0, magnetradius, 0), -current, configAdjuster);
    CurrentSegment magnetSegmennt4 = new LineSegment(translationVector, new PVector(0, -magnetradius, 0), new PVector(0, magnetradius, 0), -current, configAdjuster);
...
public class CircularMagnet implements Magnet {
  ...
  void createCurrentSegments(PVector translationVector) {
    ...
    CurrentSegment magnetSegmennt1 = new ArcSegment(translationVector, new PVector(0, 0, 0), this.radius, 360, current, 0, configAdjuster);
